...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "Enable Greeting",
			   "id" => $shortname."_greeting_enable",
			   "type" => "checkbox",
			   "std" => "false",
			   "desc" => "Enabling this option will display a a greeting on the homepage.",),

		array( "name" => "Input Greeting Text",
			   "id" => $shortname."_greeting_text",
			   "type" => "textarea",
			   "std" => "",
			   "desc" => "Enter your greeting here. ",),
