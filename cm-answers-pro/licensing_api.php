<?php
if ( !class_exists( 'CMA_Cminds_Licensing_API' ) ) {

	class CMA_Cminds_Licensing_API {

		const SHORT_SLUG				 = 'answers';
		...
		const PAGE_USER_GUIDE			 = 'https://www.cminds.com/wordpress-plugins-knowledge-base-and-documentation/?hscat=7-cm-answers';
		...
		public function __construct( $itemName, $pluginMenu, $pluginName, $pluginFile, $pluginSpecificUrls, $pluginSlug = '',
			...
			$this->pluginMenuPage		 = strtolower( $this->pluginMenu ) . '_license';
			$this->pluginUpdateMenuPage	 = strtolower( $this->pluginMenu ) . '_update';
