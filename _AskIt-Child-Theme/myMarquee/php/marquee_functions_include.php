<?php
	...
	function create_post_type_marquee() {
		register_post_type('marquee_panel',
			array(
				...
				'menu_icon'=> get_stylesheet_directory_uri() . '/myMarquee/images/admin_marquee_icon.png',
	...
	function load_marquee_scripts(){
		...
		wp_register_script('marquee_js', get_stylesheet_directory_uri() . '/myMarquee/js/marquee.js', array('jquery'));
	...
	function remove_cpt_header_slider() {
    	if( !current_user_can( 'administrator' ) ):
        	remove_menu_page( 'edit.php?post_type=marquee_panel' );
    	endif;
	}
	add_action( 'admin_menu', 'remove_cpt_header_slider' );
