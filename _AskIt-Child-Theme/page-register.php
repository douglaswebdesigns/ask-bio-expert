		...
		<div class="entry page">
			<div class="entry-top">
				<div class="entry-content">
					<h2 class="title">Submit A Question</h2>
					<div class="clear"></div>
						...
						<?php if ( !is_user_logged_in() ) { ?>
							...
							<?php } else { ?>
								<div id="register-form">
									...
									<div class="title">
										<h2><?php esc_html_e('Register New Account', 'AskIt'); ?></h2>
									</div>
									<form action="<?php echo esc_url( site_url( 'wp-login.php?action=register', 'login_post' ) ); ?>" method="post">
										...
										<p class="statement"><?php esc_html_e('Once approved, a password will be e-mailed to you.', 'AskIt');?></p>
									</form>
								</div>
							<?php } ?>
