		...
		<div id="footer-content">
			...
			<div id="footer-bottom">
				<div class="container clearfix">
					...
					<p id="copyright"><?php esc_html_e('A WordPress Website by ','AskIt'); ?> <a href="http://www.douglaswebdesigns.com" title="Douglas Web Designs">Douglas Web Designs</a> | <?php esc_html_e('Powered by ','AskIt'); ?> <a href="http://www.wordpress.org">WordPress</a></p>
				</div> <!-- end .container -->
